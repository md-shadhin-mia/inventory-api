...
return [
        ...
        'default' => [
            ...
            'paths' => [
                ...
                */
                 ...
                 *
                 * YAML: the spec is hand-authored at openapi/openapi.yaml (see
                 * `docs` under `defaults.paths` below), not generated from
                 * annotations — so the controllers stay lean.
                 */
    ...
    'defaults' => [
        ...
        'paths' => [
             ...
             *
             * Pointed at a tracked directory rather than storage/api-docs
             * because openapi.yaml is hand-authored and version-controlled
             * (and therefore also present inside the Docker image), not
             * generated from annotations at runtime.
             */
            'docs' => base_path('openapi'),
